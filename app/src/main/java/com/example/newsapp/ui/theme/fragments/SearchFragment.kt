...
import com.example.newsapp.R.layout.error
...
class SearchFragment : Fragment(R.layout.fragment_search) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
         ...
         val errorBinding = binding.itemSearchError
         retryButton = errorBinding.retryButton
         errorText = errorBinding.errorText
         itemSearchError = errorBinding.root as CardView
        val inflater = requireContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
        val view :View = inflater.inflate(error,null)
